...
class TestTransitionBase(object):
    ...
    param_test_init = [
        ...
        ([("ma1", {"ma1_1": t.zeros([])})], [("sa1", 1)], [("ca", None)],
         ValueError, "is a invalid tensor"),
        ([("ma1", {"ma1_1": t.zeros([1, 2])}),
          ("ma2", {"ma2_1": t.zeros([2, 3])})],
         [("sa1", 1)],
         [("ca", None)],
         ValueError, "has invalid batch size"),
        ([("ma1", {"ma1_1": t.zeros([1, 2])}),
          ("ma2", {"ma2_1": t.zeros([1, 3])})],
         [("sa1", 1)],
         [("ca", None)],
         None, None),
        ([("ma1", {"ma1_1": t.zeros([1, 2])}),
        ...
        ([("ma1", {"ma1_1": t.zeros([2, 2])}),
         ...
         [("sa1", 1)],
         [("ca", None)],
         ValueError, "Transition sub attribute .+ is a scalar, "
                     "but batch size is"),
        ([("ma1", {"ma1_1": t.zeros([2, 2])}),
          ("ma2", {"ma2_1": t.zeros([2, 3])})],
         [("sa1", t.zeros([]))],
         [("ca", None)],
         ValueError, "Transition sub attribute .+ is a invalid tensor"),
        ([("ma1", {"ma1_1": t.zeros([2, 2])}),
          ("ma2", {"ma2_1": t.zeros([2, 3])})],
         [("sa1", t.zeros([3, 4]))],
         [("ca", None)],
         ValueError, "Transition sub attribute .+ has invalid batch size"),
        ([("ma1", {"ma1_1": t.zeros([2, 2])}),
          ("ma2", {"ma2_1": t.zeros([2, 3])})],
         [("sa1", None)],
         [("ca", None)],
         ValueError, "Transition sub attribute .+ requires scalar or tensor"),
    ]

    @pytest.mark.parametrize("major,sub,custom,exception,match",
                             param_test_init)
    ...
    def test_attr(self, major, sub, custom):
        ...
        assert tb.keys() == ([m[0] for m in major] +
                             [s[0] for s in sub] +
                             [c[0] for c in custom])
